# Generated by Django 5.2 on 2025-05-16 08:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_type', models.CharField(choices=[('task', 'Task'), ('event', 'Event')], default='task', max_length=10)),
                ('title', models.CharField(default='Notification', max_length=200)),
                ('message', models.TextField()),
                ('priority', models.CharField(choices=[('high', 'High'), ('medium', 'Medium'), ('low', 'Low')], default='medium', max_length=10)),
                ('status', models.CharField(choices=[('unread', 'Unread'), ('read', 'Read'), ('dismissed', 'Dismissed')], default='unread', max_length=10)),
